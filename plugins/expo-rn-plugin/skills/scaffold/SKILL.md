---
name: scaffold
description: Scaffold a full CRUD feature (types, hooks, screens, routes, form) from a Supabase table. Use when creating a new feature end-to-end from a database table.
