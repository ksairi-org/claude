---
name: stripe
description: Stripe payments — PaymentSheet setup, Doppler vars, PCI compliance rules, and Stripe MCP usage. Use when adding payments, implementing checkout flows, or debugging payment events.
---
...
await initPaymentSheet({ paymentIntentClientSecret: clientSecret, merchantDisplayName: "My App" });
