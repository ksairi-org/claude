...
Shared libraries extracted from it live in [ksairi-org/libs](https://github.com/ksairi-org/libs) — a Turborepo + Changesets monorepo publishing 18 packages under the `@ksairi-org/*` npm scope. New projects that adopt the plugin can install any of these packages independently.
